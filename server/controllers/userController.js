...
const createNewUser = async (req, res) => {
    const { userName, password, name, email, address,roles, phone, active } = req.body
    console.log("aaaaaaaaaa");
    console.log(userName, password, name, email, address,roles, phone, active );
    ...
    const user = await User.create({ userName, password, name, email, address, roles, phone, active })
    if (user) {
...
const updateUser = async (req, res) => {
    const { _id, userName, password, name, email, phone, address, active } = req.body
